 ...
 *  图片资源
 */
static NSString *const CH_nofull_backIcon = @"视频返回";
static NSString *const CH_nofull_moreIcon = @"cat";
static NSString *const CH_playIcon = @"播放";
static NSString *const CH_pauseIcon = @"暂停";
static NSString *const CH_sliderIcon = @"椭圆-1";
static NSString *const CH_nofull_zoomIcon = @"kr-video-player-fullscreen";
static NSString *const CH_rewindIcon = @"后退";
static NSString *const CH_fastForwardIcon = @"前进";
static NSString *const CH_full_backIcon = @"return_white";

static NSString *const CH_cell_closeIcon = @"kr-video-player-close";
static NSString *const CH_cell_playIcon = @"dynamic _vedio_play";
