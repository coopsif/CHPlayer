...
- (void)viewDidLoad {
    ...
    // Do any additional setup after loading the view.
     ...
     CHPlayerView * playerView = [[CHPlayerView alloc] initWithFrame:rect playerType:PlayerTypeOfNavigationBar autoPlay:NO];
...
- (IBAction)changRootVC:(UIBarButtonItem *)sender {
